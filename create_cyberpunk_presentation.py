...
BG_IMAGE_PATH = r"C:\Users\NEEL\.gemini\antigravity-ide\brain\87cfe9fa-5d07-484f-844a-910f988a859e\cloudatlas_cyberpunk_bg_1785999426856.png"

# Color Palette (Dark Theme / Glassmorphism over Cyberpunk BG)
CARD_BG = RGBColor(15, 23, 42)        # Deep navy semi-dark card
CARD_BORDER = RGBColor(56, 189, 248)  # Glowing Sky Blue border
TEXT_LIGHT = RGBColor(248, 250, 252)  # White/Off-white
TEXT_MUTED = RGBColor(203, 213, 225)  # Light slate gray
ACCENT_BLUE = RGBColor(56, 189, 248)  # Sky Blue
ACCENT_PURPLE = RGBColor(192, 132, 252)# Vibrant Light Purple
...
ACCENT_ROSE = RGBColor(251, 113, 133)  # Rose Red
...
def add_bg_slide():
    ...
    # Dark overlay rectangle for extreme text readability & contrast
    overlay = slide.shapes.add_shape(MSO_SHAPE.RECTANGLE, 0, 0, Inches(13.333), Inches(7.5))
    overlay.fill.solid()
    overlay.fill.fore_color.rgb = RGBColor(5, 8, 18)
    overlay.fill.transparency = 0.35  # 35% dark tint overlay over cyberpunk backdrop
...
for i, (title, desc) in enumerate(modules):
    ...
    add_card(s4, left, top, Inches(5.6), Inches(1.5), border_color=ACCENT_BLUE)
...
prs.save("CloudAtlas_AI_Cyberpunk_7_Slide.pptx")
print("Successfully generated CloudAtlas_AI_Cyberpunk_7_Slide.pptx with customized Cyberpunk Background image!")
