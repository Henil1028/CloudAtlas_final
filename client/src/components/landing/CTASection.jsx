...
export const CTASection = () => {
  ...
  return (
    <section className="relative py-28 bg-navy-dark overflow-hidden grid-bg border-t border-white/5">
      {/* Background Orbs */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[300px] bg-primary/10 rounded-full blur-[120px] pointer-events-none animate-pulse" />
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-primary/10 border border-primary/20 text-primary text-xs font-semibold uppercase tracking-wider mb-6">
          ...
          <span>Instant Cloud Cost Control</span>
        </div>

        {/* Title */}
        <h2 className="text-3xl sm:text-5xl font-black text-white tracking-tight leading-[1.2] mb-6">
          Take Control of Your <br />
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-gold to-white">
            Cloud Spending Today
          </span>
        </h2>

        {/* Subtitle */}
        <p className="mx-auto max-w-2xl text-gray-400 text-sm sm:text-base leading-relaxed mb-10">
          Join hundreds of DevOps and FinOps engineers running predictive, automated budget controls across multi-cloud clusters.
        </p>
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
          ...
          <a
            href="mailto:demo@cloudatlas.ai"
