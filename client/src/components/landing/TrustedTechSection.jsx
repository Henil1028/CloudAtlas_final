...
export const TrustedTechSection = () => {
  ...
  return (
    <section className="bg-navy-dark/50 border-y border-white/5 py-12 overflow-hidden">
      ...
      <div className="marquee-container w-full relative">
        {/* Left fade overlay */}
        <div className="absolute top-0 bottom-0 left-0 w-24 bg-gradient-to-r from-navy-dark to-transparent z-10 pointer-events-none" />
        {/* Right fade overlay */}
        <div className="absolute top-0 bottom-0 right-0 w-24 bg-gradient-to-l from-navy-dark to-transparent z-10 pointer-events-none" />
